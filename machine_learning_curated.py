...
StepTrainerTrusted_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://gwb-stedi-lake-house/step_trainer/trusted/"],
        "recurse": True,
    },
...
AccelerometerTrusted_node1690334760836 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://gwb-stedi-lake-house/accelerometer/trusted/"],
        "recurse": True,
    },
...
MLCurated_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://gwb-stedi-lake-house/machine_learning/curated/",
        "partitionKeys": [],
    },
