...
customers_curated_node1690251327200 = glueContext.create_dynamic_frame.from_catalog(
    database="dend",
    table_name="customers_curated",
    transformation_ctx="customers_curated_node1690251327200",
)
...
step_trainer_landing_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://gwb-stedi-lake-house/step_trainer/landing/"],
        "recurse": True,
    },
...
Join_node1690251349178 = Join.apply(
    ...
    frame2=customers_curated_node1690251327200,
    keys1=["serialNumber"],
    keys2=["serialnumber"],
...
StepTrainerTrusted_node1290274040832 = glueContext.write_dynamic_frame.from_catalog(
    frame=DropFields_node1690251367538,
    database="dend",
    table_name="step_trainer_trusted",
    transformation_ctx="StepTrainerTrusted_node1290274040832",
)
