...
customer_trusted_node1689512229110 = glueContext.create_dynamic_frame.from_catalog(
    database="dend",
    table_name="customer_trusted",
    transformation_ctx="customer_trusted_node3689566619110",
)
...
CustomerPrivacyFilter_node1689563552518 = Join.apply(
    ...
    frame2=customer_trusted_node1689512229110,
    keys1=["user"],
    keys2=["email"],
...
DropFields_node1689563733947 = DropFields.apply(
    ...
    transformation_ctx="DropFields_node1719563733947",
)

# Script generated for node S3 bucket
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    frame=DropFields_node1719563733947,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://gwb-sted-lake-house/accelerometer/trusted/",
        "partitionKeys": [],
    },
